...
public interface ShopInterface {
	 ...
	 */
	List<Changelog> searchChangelogName(String name) throws ClassNotFoundException, IOException;
	...
	Changelog searchChangelogNr(int nr) throws ClassNotFoundException, IOException;
}
