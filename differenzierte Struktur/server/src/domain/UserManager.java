...
public class UserManager {
	...
	/**
	 * Description: is a manager class, which contains both customer and employee
	 * methods
	 * 
	 *
	 */
	...
	/**
	 * Description: calls Persistencemanager to read the file in which the customers
	 * are
	 * 
	 * @param datei
	 * @throws IOException
	...
	/**
	 * Description: calls Persistencemanager to read the file in which the employees
	 * are
	 * 
	 * @param datei
	 * @throws IOException
